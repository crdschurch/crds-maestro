...
describe("CardFilter", () => {
  ...
  describe ("CardFilter methods", () => {
    ...
    it("#init gets the unique filters", () => {
      cardFilter = new CRDS.CardFilter(element);
      let locationRegions = ['southwest-ohio', 'central-ohio', 'northern-ohio', 'northern-kentucky', 'central-kentucky'];
    ...
    it("#setup adds a div with a class of dropdown", () => {
      ...
      let cardFilter = new CRDS.CardFilter(element);
    ...
    it("#setup inserts HTML before this.container", () => {
      let locationsH3 = document.getElementById("locations-filter-label");

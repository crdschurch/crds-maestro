...
describe('CardCarousel', () => {
    ...
    let cardCarouselDom = `<div class="card-deck carousel" data-carousel="mobile-scroll" data-carousel-id="carousel-a1kj76" data-filter-reset-label="All Locations">
    <div class="feature-cards card-deck--expanded-layout" data-carousel="mobile-scroll" id="section-locations">
      <div class="card" data-distance="112.4" data-filter="Central Kentucky" data-location="Andover" id="8god9q" style="order: 10;">
      ...
      <div class="card" data-distance="115.9" data-filter="Central Ohio" data-location="Columbus" id="pjm3wm" style="order: 11;">
      ...
      <div class="card" data-distance="49.4" data-filter="Southwest Ohio" data-location="Dayton" id="ssu2qk" style="order: 8;">
      ...
      <div class="card" data-distance="13.1" data-filter="Southwest Ohio" data-location="East Side" id="5v0cd5" style="order: 1;">
      ...
      <div class="card" data-distance="38.1" data-filter="Northern Kentucky" data-location="Florence" id="a3491s" style="order: 6;">
      ...
      <div class="card" data-distance="92.8" data-filter="Central Kentucky" data-location="Georgetown" id="8yyvo" style="order: 9;">
      ...
      <div class="card" data-distance="14.4" data-filter="Southwest Ohio" data-location="Mason" id="op3xg8" style="order: 2;">
      ...
      <div class="card" data-distance="17.9" data-filter="Southwest Ohio" data-location="Oakley" id="8be0lf" style="order: 3;">
      ...
      <div class="card" data-distance="43.1" data-filter="Southwest Ohio" data-location="Oxford" id="mk0iio" style="order: 7;">
      ...
      <div class="card" data-distance="128.2" data-filter="Central Kentucky" data-location="Richmond" id="thote8" style="order: 12;">
      ...
      <div class="card" data-distance="23.4" data-filter="Southwest Ohio" data-location="Uptown" id="dwbbh8" style="order: 4;">
      ...
      <div class="card" data-distance="35.3" data-filter="Southwest Ohio" data-location="West Side" id="3qbfxs" style="order: 5;">
      ...
      <div class="card" data-filter="" data-location="Anywhere" id="e3tlik" style="order: 13;">
    ...
    it('should create carousel', () => {
        const carousel = new CRDS.CardCarousels(cardCarouselDom);
    ...
    it('should put null values at the end of the ordering', () => {
